...
void plot()
{
    ...
    TFile *f_mzp1 = TFile::Open("gz0_4Tb1_0.root"); //dm=10
    TFile *f_mzp2 = TFile::Open("gz0_8Tb1_0.root"); //old
    TFile *f_mzp3 = TFile::Open("gz1_2Tb1_0.root");
...
//h_cosThetaStar;h_cosPhi;h_Bm0;h_BmT0;h_BmT1;h_By0;h_By1
    ...
    leg->AddEntry(h_A0m1,"gz = 0.4, tb = 1.0");
    leg->AddEntry(h_A0m2,"gz = 0.8, tb = 1.0");
    leg->AddEntry(h_A0m3,"gz = 1.2, tb = 1.0");
